...
if (!isset($_SESSION['user_id']) || ($_SESSION['role'] !== 'member' && $_SESSION['role'] !== 'admin')) {
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown">
            <?php
            if (isset($_SESSION['user_id']) && ($_SESSION['role'] === 'member' || $_SESSION['role'] === 'admin')) {
              $fullname = $_SESSION['username']; // Mendapatkan nama lengkap pengguna
              echo "
                    <li class='dropdown'>
                      <a href='#'><span>Welcome, $fullname</span> <i class='bi bi-chevron-down'></i></a>
                      <ul>
                        <li>
              ...
              echo "<a class='getstarted scrollto' href='admin/login.php'>Masuk</a>";
            }
            ?>
                ...
                <div class='portfolio-wrap'>
                    ...
                    <div class='portfolio-info'>
                        ...
                        <div class='portfolio-links'>
                            ...
                            <a href='$linkDetail' title='More Details' target='_blank'><i class='bi bi-whatsapp'></i></a>
                        </div>
                    </div>
                </div>
            </div>
